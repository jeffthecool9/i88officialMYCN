...
const payments = [
  { name: 'TruePay',        color: 'text-blue-400' },
  { name: "Touch 'n Go",    color: 'text-green-400' },
  { name: 'FPX',            color: 'text-red-400' },
  { name: 'GrabPay',        color: 'text-green-300' },
...
const trust = [
  { Icon: IconLock,    label: 'SSL加密' },
  { Icon: IconBolt,    label: '快速提款' },
  { Icon: IconShield,  label: '负责任博彩' },
  { Icon: IconSupport, label: '24/7客服' },
]
  ...
  return (
    <section className="py-12 px-6">
      ...
      <div className="max-w-md mx-auto">
        ...
        >
          <h2 className="font-display text-3xl text-ice tracking-widest">可信 · 安全 · 保障</h2>
          <p className="font-body text-ice/40 text-sm mt-1">持牌及受监管 · 马来西亚</p>
        </motion.div>
        ...
        >
          仅限18+。负责任博彩。i88支持马来西亚安全博彩。
          马来西亚 <span className="text-brand/40">1-800-88-3151</span>
        </motion.p>
      </div>
    </section>
  )
